...
<html>
    ...
    <body>
        ...
        <div id="show-assunto" class="content scaffold-show" role="main">
            ...
            <f:display bean="assunto" />
            <g:form resource="${this.assunto}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.assunto}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
